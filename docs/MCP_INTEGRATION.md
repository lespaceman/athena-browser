...
1. Add `--remote-debugging-port=9222` to CEF settings
2. Rebuild and run Athena Browser
3. Use `npx athena-browser-mcp` or configure Claude Desktop
4. Optionally remove old agent/ MCP code

This gives you 2.3x more tools with industry-standard CDP protocol and less code to maintain!
